...
export const REQUIRED_PACKAGED_RUNTIME_ENTRIES = [
  ...
  'node_modules/dsh-plugin-gala/lib/client.js',
...
export const REQUIRED_UNPACKED_RUNTIME_ENTRIES = [
  ...
  'node_modules/@deepseek-ai/dsh-app-boot/lib/index.js',
  'node_modules/@deepseek-ai/dsh-web-frontend/dist/index.html',
  'node_modules/dsh-plugin-gala/package.json',
  'node_modules/dsh-plugin-gala/lib/index.js',
  'node_modules/dsh-plugin-gala/lib/client.js',
  'node_modules/dsh-plugin-gala/assets/gala/officials/stars/assets/portrait-v2.webp',
  'node_modules/dsh-plugin-gala/assets/gala/officials/stars/assets/hero-v2.webp',
  'node_modules/dsh-plugin-gala/assets/gala/officials/dsh-base/assets/idle.png',
 ...
 * node-pty 1.2 is ConPTY-only on Windows: the npm tarball ships the conpty addon plus the
 * bundled conpty.dll/OpenConsole.exe pair, and no longer carries the legacy winpty binaries.
 */
...
export const REQUIRED_UNPACKED_PACKAGE_SPECIFIERS = [
  ...
  'dsh-plugin-gala',
  'dsh-plugin-gala/client',
  'dsh-plugin-gala/package.json',
