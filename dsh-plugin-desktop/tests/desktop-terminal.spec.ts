...
function macOptions(stateDir: string, spawn: DesktopTerminalSpawn): DesktopTerminalOptions {
  return {
    platform: 'darwin',
    appExecutable: "/Applications/Gala O'Brien.app/Contents/MacOS/DeepSeek Harness Desktop Gala",
    dshBootstrapPath: "/Applications/Gala O'Brien.app/Contents/Resources/app.asar/lib/dsh-terminal-bootstrap.js",
    pnpmBinPath: "/Applications/Gala O'Brien.app/Contents/Resources/app.asar/node_modules/pnpm/bin/pnpm.mjs",
    electronVersion: '43.4.0',
    profileName: 'desktop',
    productVersion: '2.0.0',
    profileDir: "/Users/example/Library/Application Support/Gala O'Brien/profiles/desktop",
    homeDir: "/Users/example/Library/Application Support/Gala O'Brien",
    stateDir,
    spawn,
    environment: {
...
function windowsOptions(stateDir: string, spawn: DesktopTerminalSpawn): DesktopTerminalOptions {
  return {
    platform: 'win32',
    appExecutable: 'C:\\Program Files\\DSH 100% Desktop\\DeepSeek Harness Desktop Gala.exe',
    dshBootstrapPath: 'C:\\Program Files\\DeepSeek Harness Desktop Gala\\resources\\app.asar\\lib\\dsh-terminal-bootstrap.js',
    pnpmBinPath: 'C:\\Program Files\\DeepSeek Harness Desktop Gala\\resources\\app.asar\\node_modules\\pnpm\\bin\\pnpm.mjs',
    electronVersion: '43.4.0',
    profileName: 'desktop',
    productVersion: '2.0.0',
    profileDir: "C:\\Users\\Example\\Gala O'Brien\\profiles\\desktop",
    homeDir: "C:\\Users\\Example\\Gala O'Brien",
    stateDir,
    spawn,
    environment: {
...
describe('desktop terminal environment', () => {
  ...
  it('generates private macOS shims and opens one quoted welcome command', () => {
    ...
    expect(dshShim).toContain("'/Applications/Gala O'\"'\"'Brien.app/Contents/MacOS/DeepSeek Harness Desktop Gala'")
    expect(dshShim).toContain("'/Applications/Gala O'\"'\"'Brien.app/Contents/Resources/app.asar/lib/dsh-terminal-bootstrap.js'")
    ...
    expect(nodeShim).toBe([
      '#!/bin/sh',
      `ELECTRON_RUN_AS_NODE=1 exec '/Applications/Gala O'"'"'Brien.app/Contents/MacOS/DeepSeek Harness Desktop Gala' "$@"`,
      '',
    ].join('\n'))
    ...
    expect(welcome).toContain('DeepSeek Harness Desktop Gala 2.0.0 terminal')
    ...
    expect(welcome).toContain('Restart DeepSeek Harness Desktop Gala after plugin changes.')
    expect(welcome).not.toContain(' -l')
    expect(welcome).toContain("Gala O'\"'\"'Brien")
  ...
  it('generates Windows batch shims and opens PowerShell through a visible-console broker', () => {
    ...
    expect(welcome).toContain('"DeepSeek Harness Desktop Gala {0} terminal" -f $env:DSH_DESKTOP_PRODUCT_VERSION')
    ...
    expect(launcher).toContain('start "DeepSeek Harness Desktop Gala" /D "!DSH_DESKTOP_PROFILE_DIRECTORY!"')
  ...
  it('keeps Windows scripts ASCII and passes localized paths through the child environment', () => {
    ...
    options.appExecutable = 'C:\\程序\\DeepSeek Harness Desktop Gala.exe'
    ...
    expect(harness.calls[0]?.options.env).toEqual(expect.objectContaining({
      ...
      DSH_DESKTOP_APP_EXECUTABLE: 'C:\\程序\\DeepSeek Harness Desktop Gala.exe',
