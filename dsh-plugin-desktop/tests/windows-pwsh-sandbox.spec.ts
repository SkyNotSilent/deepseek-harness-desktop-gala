...
const adaptation: WindowsAclAdaptation = {
  platform: 'win32',
  electron: true,
  execPath: 'C:\\Program Files\\DeepSeek Harness Desktop Gala\\DeepSeek Harness Desktop Gala.exe',
  upstreamRunner: 'C:\\Program Files\\DeepSeek Harness Desktop Gala\\resources\\app.asar\\runner.js',
  trampoline: 'C:\\Program Files\\DeepSeek Harness Desktop Gala\\resources\\app.asar\\desktop-runner.js',
}
