/** Headless-safe npm launcher for the DeepSeek Harness Desktop Gala Electron executable. */
...
Launch DeepSeek Harness Desktop Gala with the selected Web-capable profile.
